...
if (isset($_POST['add_customer'])) {
    ...
    $stmt = $conn->prepare("INSERT INTO customers (customer_name, phone, email, vehicle_no, vehicle_model, ) VALUES (?, ?, ?, ?)");
                        ...
                        <tr>
                            ...
                            <td class="text-center">
                                <div class="btn-group customer-action-btns">
                                    <a href="../cashier/invoice.php?customer_id=<?php echo urlencode($row['customer_id']); ?>"
                                    ...
                                    <a href="customers.php?delete=<?php echo urlencode($row['customer_id']); ?>" 
                                       class="btn btn-sm btn-outline-danger" 
                                       title="Delete Customer"
                                       onclick="return confirm('Are you sure you want to delete this customer? Historical sales logs will retain their IDs.');">
                    ...
                    ?>
                        <tr>
                            <td colspan="6" class="text-center py-5 text-muted">
                                ...
                                No customers registered. Click "Add New Customer" to log custom profiles.
                            </td>
                        </tr>
                    <?php } ?>
                </tbody>
...
<div class="modal fade" id="addCustomerModal" tabindex="-1" aria-labelledby="addCustomerModalLabel" aria-hidden="true">
    ...
    <input type="text" name="vehicle_model" class="form-control" placeholder="e.g. Toyota Corolla">
</div>
<div class="mb-3">
    <label class="form-label">Vehicle Year</label>
    <input type="number" name="vehicle_year" class="form-control" placeholder="e.g. 2018" min="1900" max="2099">
</div>
                </div>
